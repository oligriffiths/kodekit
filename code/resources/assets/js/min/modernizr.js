/*!
 * modernizr v3.0.0
 * Build http://modernizr.com/download?-appearance-checked-flexbox-flexboxlegacy-flexboxtweener-flexwrap-pointerevents-touchevents-prefixed-prefixedcss-shiv-dontmin
 *
 * Copyright (c)
 *  Faruk Ates
 *  Paul Irish
...
!*/
u.addTest("flexwrap",r("flexWrap","wrap",!0));var G=function(a){function c(b,c){var e;return b?(c&&"string"!=typeof c||(c=h(c||"div")),b="on"+b,e=b in c,!e&&d&&(c.setAttribute||(c=h("div")),c.setAttribute(b,""),e="function"==typeof c[b],c[b]!==a&&(c[b]=a),c.removeAttribute(b)),e):!1}var d=!("onblur"in b.documentElement);return c}();t.hasEvent=G,/*!
{
...
!*/
u.addTest("pointerevents",function(){var a=!1,b=C.length;for(a=u.hasEvent("pointerdown");b--&&!a;)G(C[b]+"pointerdown")&&(a=!0);return a});var H=t._config.usePrefixes?" -webkit- -moz- -o- -ms- ".split(" "):[];t._prefixes=H,/*!
{
  "name": "Touch Events",
...
!*/
u.addTest("touchevents",function(){var c;if("ontouchstart"in a||a.DocumentTouch&&b instanceof DocumentTouch)c=!0;else{var d=["@media (",H.join("touch-enabled),("),"heartz",")","{#modernizr{top:9px;position:absolute}}"].join("");F(d,function(a){c=9===a.offsetTop})}return c}),e(),f(v),delete t.addTest,delete t.addAsyncTest;for(var I=0;I<u._q.length;I++)u._q[I]();a.Modernizr=u}(window,document);
